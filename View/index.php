...
<body>
    ...
    <table id="c0" width="100%" height="700">
        <tr><td></td><td><h1 style="color: red;text-align: center;">Used Cars</h1><br><br></td></tr>
        <tr>
            <td id="c1"><img src="img/premio16.jpeg" width="100%"></td>
            <td id="c2"><img src="img/hiace19.jpg" width="100%"></td>
            <td id="c3"><img src="img/axio13.jpg" width="100%"></td>
        </tr>
        <tr>
            <td>
            <center>
        ...
        <table id="c0" width="100%" height="700">
        <tr>
            <td id="c1"><img src="img/noah02.jpg" width="100%"></td>
            <td id="c2"><img src="img/prius19.jpeg" width="100%"></td>
            <td id="c1"><img src="img/alion07.jpeg" width="100%" ></td>
        </tr>
        <tr>
            <td>
            <center>
